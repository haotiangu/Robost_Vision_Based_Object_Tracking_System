...
def test_fastdvdnet(**args):
	...
	with torch.no_grad():
		...
		seqn = seq + noise
		noisestd = torch.FloatTensor([args['noise_sigma']]).to(device) # this one has been nomalized
...
if __name__ == "__main__":
	...
	parser.add_argument("--test_path", type=str, default="/home/haotiangu/derf_540p_seqs/park_joy", \
